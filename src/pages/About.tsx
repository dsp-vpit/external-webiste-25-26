...
const ecMembers = [
  ...
  { name: "Soumil Vomma", role: "VP Professional Activities", img: '/images/headhsots/Beta Mu/soumilVoma.jpeg' },
...
const pledgeClasses = [
  ...
  },
  {
    name: 'Beta Rho',
    members: [
      { name: 'Ethan Amaning', img: '/images/headhsots/Beta Rho/ethanAmaning.png' },
      { name: 'Tanya Bahety', img: '/images/headhsots/Beta Rho/tanyaBahety.jpeg' },
      { name: 'Sara Han', img: '/images/headhsots/Beta Rho/saraHan.jpeg' },
      { name: 'Dana Hartley', img: '/images/headhsots/Beta Rho/danaHartley.jpeg' },
      { name: 'Kennady Hughes', img: '/images/headhsots/Beta Rho/kennadyHughes.jpeg' },
      { name: 'Anjali Kadimi', img: '/images/headhsots/Beta Rho/anjaliKadimi.jpeg' },
      { name: 'Jihan Kapur', img: '/images/headhsots/Beta Rho/jihanKapur.jpeg' },
      { name: 'Ivana Kovalska', img: '/images/headhsots/Beta Rho/ivanaKovalska.jpeg' },
      { name: 'Sanya Mohta', img: '/images/headhsots/Beta Rho/sanyaMohta.jpeg' },
      { name: 'Sanika Niranjan', img: '/images/headhsots/Beta Rho/sanikaNiranjan.jpeg' },
      { name: 'Roy Park', img: '/images/headhsots/Beta Rho/royPark.jpeg' },
      { name: 'Arjun Patil', img: '/images/headhsots/Beta Rho/arjunPatil.jpeg' },
      { name: 'Charlotte Sander', img: '/images/headhsots/Beta Rho/charlotteSander.jpeg' },
      { name: 'Shane Semien', img: '/images/headhsots/Beta Rho/shaneSemien.jpeg' },
      { name: 'Aarush Sen', img: '/images/headhsots/Beta Rho/aarushSen.jpeg' },
      { name: 'Gina Singh', img: '/images/headhsots/Beta Rho/ginaSingh.jpeg' },
      { name: 'Adhit Eswaramoorthi', img: '/images/headhsots/Beta Rho/adhitEswaramoorthi.jpeg' },
      { name: 'Ashita Virani', img: '/images/headhsots/Beta Rho/ashitaVirani.jpeg' },
